        ...
        <div className='card w-10/12 m-auto flex flex-row flex-wrap justify-center bg-base-100 shadow-xl'>
            ...
            <div className="text-center">
                ...
                <div className='flex flex-col'>
                    {sendStatus ? <NavLink to = "" className="btn btn-primary bg-info w-24 mx-auto">Ver Carrito</NavLink> : <div className="card-actions justify-center"><ItemCount stock = {5} initial = {1} onAdd ={(n) => onAddEvent(n)}/></div>}
                    <div></div>
